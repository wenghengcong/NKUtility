...
extension QuerySet {
  ...
  public func filter(_ predicate: QueryPredicate<ModelType>) -> QuerySet<ModelType> {
  ...
  public func exclude(_ predicate: QueryPredicate<ModelType>) -> QuerySet<ModelType> {
  ...
  public func filter(_ closure:((ModelType.Type) -> (QueryPredicate<ModelType>))) -> QuerySet<ModelType> {
  ...
  public func exclude(_ closure:((ModelType.Type) -> (QueryPredicate<ModelType>))) -> QuerySet<ModelType> {
  ...
  @available(*, deprecated, renamed: "filter(_:)", message: "Replaced by KeyPath filtering https://git.io/Jv2v3")
  public func filter(_ closures:[((ModelType.Type) -> (QueryPredicate<ModelType>))]) -> QuerySet<ModelType> {
    return filter(closures.map { $0(ModelType.self).predicate })
  }

  /// Returns a new QuerySet containing objects that exclude the given predicates.
  @available(*, deprecated, renamed: "exclude(_:)", message: "Replaced by KeyPath filtering https://git.io/Jv2v3")
  public func exclude(_ closures:[((ModelType.Type) -> (QueryPredicate<ModelType>))]) -> QuerySet<ModelType> {
