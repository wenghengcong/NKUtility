//
//  NKPlaceholderCollectionView.swift
//  Pods
//
...
open class NKPlaceholderCollectionView: UICollectionView {
    ...
    open override weak var dataSource: UICollectionViewDataSource? {
        didSet {
            ...
            if  dataSource is NKPlaceholderDataSourceDelegate { return }
    ...
    private func setup() {
        ...
        register(cellType: NKPlaceholderCollectionViewCell.self)
    ...
    internal func switchTo(dataSource theDataSource: UICollectionViewDataSource?, delegate theDelegate: UICollectionViewDelegate? = nil) {
        ...
        if theDataSource is NKPlaceholderDataSourceDelegate {
            // NKPlaceholder configuration
