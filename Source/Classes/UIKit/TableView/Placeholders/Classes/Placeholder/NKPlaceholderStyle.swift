...
/// NKPlaceholderStyle is used to customise the placeholder cell style
public struct NKPlaceholderStyle {
    ...
    /// Create and return a NKPlaceholderStyle object
    public init() {}
}
