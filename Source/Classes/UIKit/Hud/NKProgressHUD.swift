...
//-----------------------------------------------------------------------------------------------------------------------------------------------
public enum NKProgressHUDAnimationType {
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
public enum NKProgressHUDAnimatedIcon {
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
public enum NKProgressHUDAlertIcon {
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension NKProgressHUDAlertIcon {
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
public extension NKProgressHUD {

	class var animationType: NKProgressHUDAnimationType {
...
public extension NKProgressHUD {
	...
	// MARK: -
	//-------------------------------------------------------------------------------------------------------------------------------------------
    class func show(_ status: String? = nil, icon: NKProgressHUDAlertIcon, tintColor: UIColor, interaction: Bool = true) {

        let image = icon.image?.withTintColor(tintColor, renderingMode: .alwaysOriginal)
	...
	class func show(_ status: String? = nil, icon: NKProgressHUDAlertIcon, interaction: Bool = true) {
        show(status, icon: icon, tintColor: shared.colorAnimation, interaction: interaction)
	}

	//-------------------------------------------------------------------------------------------------------------------------------------------
	class func show(_ status: String? = nil, icon animatedIcon: NKProgressHUDAnimatedIcon, interaction: Bool = true) {
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
public class NKProgressHUD: UIView {

	private var viewBackground: UIView?
	private var toolbarHUD: UIToolbar?
	private var labelStatus: UILabel?

	private var viewProgress: NKProgressView?
	...
	private var animationType	= NKProgressHUDAnimationType.systemActivityIndicator
	...
	//-------------------------------------------------------------------------------------------------------------------------------------------
	static let shared: NKProgressHUD = {
		let instance = NKProgressHUD()
		return instance
	} ()
	...
	// MARK: -
	//-------------------------------------------------------------------------------------------------------------------------------------------
	private func setup(status: String? = nil, progress: CGFloat? = nil, animatedIcon: NKProgressHUDAnimatedIcon? = nil, staticImage: UIImage? = nil, hide: Bool, interaction: Bool) {
	...
	private func setupProgress(_ progress: CGFloat?) {
		...
		if (viewProgress == nil) {
			viewProgress = NKProgressView(colorProgress)
	...
	//-------------------------------------------------------------------------------------------------------------------------------------------
	private func setupAnimatedIcon(_ animatedIcon: NKProgressHUDAnimatedIcon?) {
...
// MARK: - NKProgressView
//-----------------------------------------------------------------------------------------------------------------------------------------------
private class NKProgressView: UIView {
