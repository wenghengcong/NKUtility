...
class NKSliderValueView : UIView {
    ...
    override func layoutSubviews() {
        ...
        innerShapeLayer.path = UIBezierPath(ovalIn: shapeView.bounds.insetBy(dx: NKSliderValueView.kLayoutMarginInset, dy: NKSliderValueView.kLayoutMarginInset)).cgPath
