...
public extension UIViewController {
    ...
    func showAlert(
        ...
        completion: ((Int) -> Void)? = nil) -> UIAlertController {
            let alertController = UIAlertController(alertTitle: title, message: message, actionTitles: buttonTitles, highlightedButtonIndex: highlightedButtonIndex, completion: completion)
