...
public extension UIAlertController {
    ...
    convenience init(
        title: String?,
        message: String? = nil,
        leftActionButtonTitle: String,
        leftActionStyle: UIAlertAction.Style = .default,
        leftHandler: ((UIAlertAction) -> Void)? = nil,
        rightActionButtonTitle: String,
        rightActionStyle:UIAlertAction.Style,
        rightHandler: ((UIAlertAction) -> Void)? = nil) {
        self.init(title: title, message: message, preferredStyle: .alert)
        
        let leftAction = UIAlertAction(title: leftActionButtonTitle, style: leftActionStyle, handler: leftHandler)
        addAction(leftAction)
        
        let rightAction = UIAlertAction(title: rightActionButtonTitle, style: rightActionStyle, handler: rightHandler)
