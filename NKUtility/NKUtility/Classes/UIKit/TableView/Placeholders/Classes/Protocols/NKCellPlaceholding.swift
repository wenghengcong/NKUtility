...
protocol NKCellPlaceholding {
    ...
    func apply(style: NKPlaceholderStyle, tintColor: UIColor?)
    
    ///  Sets in the cell the placeholder texts, image, ...
    ///
    /// - Parameter data: the data of the cell (texts, images, etc)
    func apply(data: NKPlaceholderData?)
}


// MARK: default implementation
extension NKCellPlaceholding {
    ...
    ///   - style: the style to apply
    ///   - tintColor: the tint color, is used for some items when the style color is nil
    internal func apply(style: NKPlaceholderStyle, tintColor: UIColor?) {
    ...
    ///
    /// - Parameter data: the data of the cell (texts, images, etc)
    internal func apply(data: NKPlaceholderData?) {
