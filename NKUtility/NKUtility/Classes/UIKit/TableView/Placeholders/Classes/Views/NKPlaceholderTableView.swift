...
/// The delegate of a NKPlaceholderTableView/NKPlaceholderCollectionView object must adopt the NKPlaceholderDelegate protocol. the method of the protocol allow the delegate to perform placeholders action.
public protocol NKPlaceholderDelegate: class {
...
open class NKPlaceholderTableView: UITableView {
     ...
     * The delegate must adopt the NKPlaceholderDelegate protocol. The delegate is not retained.
     */
    public weak var placeholderDelegate: NKPlaceholderDelegate?
    ...
    weak open override var dataSource: UITableViewDataSource? {
        didSet {
            ...
            if  dataSource is NKPlaceholderDataSourceDelegate {
                return
            }
    ...
    open override weak var delegate: UITableViewDelegate? {
        didSet {
            ...
            if  delegate is NKPlaceholderDataSourceDelegate {
                return
            }
    ...
    /**
     ...
     Returns an initialized NKPlaceholderTableView object, or nil if the object could not be successfully initialized.
     ...
     - returns: Returns an initialized NKPlaceholderTableView object, or nil if the object could not be successfully initialized.
     */
    ...
    private func setup() {
        ...
        register(cellType: NKPlaceholderTableViewCell.self)
    ...
    internal func switchTo(dataSource theDataSource: UITableViewDataSource?, delegate theDelegate: UITableViewDelegate? = nil) {
        ...
        if let placeholderDataSource = theDataSource as? NKPlaceholderDataSourceDelegate {
