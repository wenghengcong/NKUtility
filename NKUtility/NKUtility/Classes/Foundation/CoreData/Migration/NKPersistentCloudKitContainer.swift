...
///
/// See `NKPersistentContainer` for a version that does not support CloudKit-backed stores.
///
@available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
open class NKPersistentCloudKitContainer: NSPersistentCloudKitContainer, NKPersistentContainerMigratable, NKPersistentContainerProtocol, LogMessageEmitter {
