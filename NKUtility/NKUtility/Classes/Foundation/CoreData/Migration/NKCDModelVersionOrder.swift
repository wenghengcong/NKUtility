...
public enum NKCDModelVersionOrder {
    ...
    case perStore((NSPersistentStoreDescription) -> NKCDModelVersionOrder)
}

@available(macOS 10.12, iOS 10.0, tvOS 10.0, watchOS 3.0, *)
extension NKCDModelVersionOrder {

    /// Check user parameters are valid.  Compile any regex.
    func prepare(for storeDescription: NSPersistentStoreDescription) -> NKCDModelVersionOrder? {
        switch self {
        case .compare:
            return self
...
@available(macOS 10.12, iOS 10.0, tvOS 10.0, watchOS 3.0, *)
extension NKCDModelVersionOrder: CustomStringConvertible {
